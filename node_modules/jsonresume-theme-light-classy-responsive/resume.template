...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="https://cdn.rawgit.com/FortAwesome/Font-Awesome/307323a6a7fe69b7018cb49d2b7e43e1f4b6c92b/css/font-awesome.min.css" />
		<style type="text/css">
/*<!--*/
body {
	font-size: 62.5%;
	...
	<body>
		<div class="main-wrap">
			<header class="header">
				...
				{{#phoneBool}}
					<li class="contact-header">{{basics.phone}} | </li>
				{{/phoneBool}}
				{{#emailBool}}
					<li class="contact-header"><a href="mailto:{{basics.email}}">{{basics.email}}</a></li>
				{{/emailBool}}
				{{#websiteBool}}
					<li class="contact-header"><a href="{{basics.website}}"> | {{basics.website}}</a></li>
				{{/websiteBool}}
				</ul>
				<ul id="profiles" class="profiles-list list-set">
				{{#basics.profiles}}
					<li><a href="{{url}}" class="profile" title="{{network}}"><i class="{{faclass}}"></i><span class="profile-name">{{network}}</span></a></li>
				{{/basics.profiles}}
				</ul>
			</header>
			<main role="main" class="main">
				...
				<section id="work" class="section">
					...
					{{#work}}
					<section class="section-sub section-sub-job">
						{{#position}}
							{{#company}}
				...
				<section id="education" class="section">
					...
					{{#education}}
					<section class="section-sub section-sub-education">
						{{#studyType}}
				...
				<section id="publications" class="section">
					<h2><i class="fa fa-book left"></i>Projects</h2>
					{{#publications}}
					<section class="section-sub section-sub-publication">
						<h3>{{name}}</h3>
						<h4>{{day}} {{month}} {{year}}</h4>
						<p>{{summary}}</p>
						<h4>Website: <a target="_blank" href="{{website}}">{{website}}</a></h4>
					</section>
					{{/publications}}
				</section>
				{{/publicationsBool}}
				...
				<section id="skills" class="section">
					...
					{{#skills}}
					<section class="section-sub section-sub-skill">
				...
				<section id="awards" class="section">
					...
					{{#awards}}
					<section class="section-sub section-sub-award">
						<h3>{{title}} - {{awarder}}</h3>
						<h4>{{day}} {{month}} {{year}}</h4>
						<p>{{summary}}</p>
					</section>
				...
				<section id="interests" class="section">
					...
					{{#interests}}
					<section class="section-sub section-sub-interest">
						<h3 class="skills">{{name}}</h3>
						<ul class="list-set keywords">
						{{#keywords}}
							<li>{{.}}</li>
				...
				<section id="languages" class="section">
					<h2><i class="fa fa-quote-left left"></i>Languages</h2>
					{{#languages}}
					<section class="section-sub section-sub-language">
						<h3>{{language}}</h3>
						<p>Fluency: {{fluency}}</p>
					</section>
					{{/languages}}
